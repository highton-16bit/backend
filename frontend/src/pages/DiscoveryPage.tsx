  ...
  if (!GOOGLE_MAPS_API_KEY) {
    return (
      <div className="h-full flex flex-col items-center justify-center p-6">
        ...
        <p className="font-bold text-slate-500">Google Maps API 키가 필요합니다</p>
        <p className="text-sm text-slate-400 mt-1">VITE_GOOGLE_MAPS_KEY 환경 변수를 설정해주세요</p>
      </div>
    )
  }
